...
add_action( 'plugins_loaded', 'usdt_gateway_init', 11 );
function usdt_gateway_init() {

    if ( class_exists( 'WC_Payment_Gateway' ) ) {
        class Usdt_Gateway extends WC_Payment_Gateway {

            /**
             * Usdt_Gateway constructor.
             *
             * @since 1.0
             * @version 1.0
             */
            public function __construct() {
                ...
                $this->id                 = 'usdt_nowpayments';
                $this->title              = $this->get_option( 'title' );
                $this->icon               = apply_filters( 'wcnp_icon', NPWC_PLUGIN_URL . '/assets/images/usdttrc20.png' );
                $this->has_fields         = false;
                $this->method_title       = 'USDT TRC20 NOWPayments';
                ...
                add_action( 'woocommerce_api_usdt_gateway', array( $this, 'ipn_callback' ) );
            ...
            public function init_form_fields() {
                ...
                $this->form_fields = array(
                    ...
                    'webhook_url'         => array(
                        'title'             => 'Webhook URL',
                        'type'              => 'text',
                        'default'           => add_query_arg( 'wc-api', 'Usdt_Gateway', home_url( '/' ) ),
 ...
 * @version 1.0
 */
if ( !function_exists( 'add_usdt_nowpayments_to_wc' ) ) :
    function add_usdt_nowpayments_to_wc( $gateways ) {
        $gateways[] = 'Usdt_Gateway';
        return $gateways;
    }
endif;

add_filter( 'woocommerce_payment_gateways', 'add_usdt_nowpayments_to_wc' );
