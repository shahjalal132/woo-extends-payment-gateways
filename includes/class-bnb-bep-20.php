...
add_action( 'plugins_loaded', 'bnb_dep_init', 11 );
function bnb_dep_init() {

    if ( class_exists( 'WC_Payment_Gateway' ) ) {
        class Bnb_dep extends WC_Payment_Gateway {
            ...
            public function __construct() {
                ...
                $this->id                 = 'bnb_dep_nowpayments';
                $this->title              = $this->get_option( 'title' );
                $this->icon               = apply_filters( 'wcnp_icon', NPWC_PLUGIN_URL . '/assets/images/bnb.png' );
                $this->has_fields         = false;
                $this->method_title       = 'BNB BEP20 NOWPayments';
                ...
                add_action( 'woocommerce_api_bnb_dep', array( $this, 'ipn_callback' ) );
            ...
            public function init_form_fields() {
                ...
                $this->form_fields = array(
                    ...
                    'webhook_url'         => array(
                        'title'             => 'Webhook URL',
                        'type'              => 'text',
                        'default'           => add_query_arg( 'wc-api', 'Bnb_dep', home_url( '/' ) ),
 ...
 * @version 1.0
 */
if ( !function_exists( 'add_bnb_dep_nowpayments_to_wc' ) ) :
    function add_bnb_dep_nowpayments_to_wc( $gateways ) {
        $gateways[] = 'Bnb_dep';
        return $gateways;
    }
endif;

add_filter( 'woocommerce_payment_gateways', 'add_bnb_dep_nowpayments_to_wc' );
