...
add_action( 'plugins_loaded', 'btc_npwc_gateway_init', 11 );
function btc_npwc_gateway_init() {

    if ( class_exists( 'WC_Payment_Gateway' ) ) {
        class BTC_NPWC_Gateway extends WC_Payment_Gateway {

            /**
             * BTC_NPWC_Gateway constructor.
             *
             * @since 1.0
             * @version 1.0
             */
            public function __construct() {
                ...
                add_action( 'woocommerce_api_bTC_npwc_gateway', array( $this, 'ipn_callback' ) );
            ...
            public function init_form_fields() {
                ...
                $this->form_fields = array(
                    ...
                    'webhook_url'         => array(
                        'title'             => 'Webhook URL',
                        'type'              => 'text',
                        'default'           => add_query_arg( 'wc-api', 'BTC_NPWC_Gateway', home_url( '/' ) ),
 ...
 * @version 1.0
 */
if ( !function_exists( 'add_btc_nowpayments_to_wc' ) ) :
    function add_btc_nowpayments_to_wc( $gateways ) {
        $gateways[] = 'BTC_NPWC_Gateway';
        return $gateways;
    }
endif;

add_filter( 'woocommerce_payment_gateways', 'add_btc_nowpayments_to_wc' );
