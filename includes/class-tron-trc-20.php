...
add_action( 'plugins_loaded', 'tron_trc_init', 11 );
function tron_trc_init() {

    if ( class_exists( 'WC_Payment_Gateway' ) ) {
        class Tron_Trc extends WC_Payment_Gateway {

            /**
             * Tron_Trc constructor.
             *
             * @since 1.0
             * @version 1.0
             */
            public function __construct() {
                ...
                $this->id                 = 'tron_trc_nowpayments';
                $this->title              = $this->get_option( 'title' );
                $this->icon               = apply_filters( 'wcnp_icon', NPWC_PLUGIN_URL . '/assets/images/tron-trc20.png' );
                $this->has_fields         = false;
                $this->method_title       = 'TRON TRC20 NOWPayments';
                ...
                add_action( 'woocommerce_api_tron_trc', array( $this, 'ipn_callback' ) );
            ...
            public function init_form_fields() {
                ...
                $this->form_fields = array(
                    ...
                    'webhook_url'         => array(
                        'title'             => 'Webhook URL',
                        'type'              => 'text',
                        'default'           => add_query_arg( 'wc-api', 'Tron_trc', home_url( '/' ) ),
 ...
 * @version 1.0
 */
if ( !function_exists( 'add_tron_trc_nowpayments_to_wc' ) ) :
    function add_tron_trc_nowpayments_to_wc( $gateways ) {
        $gateways[] = 'Tron_Trc';
        return $gateways;
    }
endif;

add_filter( 'woocommerce_payment_gateways', 'add_tron_trc_nowpayments_to_wc' );
