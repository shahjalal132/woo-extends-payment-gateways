...
add_action( 'plugins_loaded', 'etherium_gateway_init', 11 );
function etherium_gateway_init() {

    if ( class_exists( 'WC_Payment_Gateway' ) ) {
        class Etherium_Gateway extends WC_Payment_Gateway {

            /**
             * Etherium_Gateway constructor.
             *
             * @since 1.0
             * @version 1.0
             */
            public function __construct() {
                ...
                $this->id                 = 'etherium_nowpayments';
                $this->title              = $this->get_option( 'title' );
                $this->icon               = apply_filters( 'wcnp_icon', NPWC_PLUGIN_URL . '/assets/images/etherium.png' );
                $this->has_fields         = false;
                $this->method_title       = 'Etherium NOWPayments';
                ...
                add_action( 'woocommerce_api_etherium_gateway', array( $this, 'ipn_callback' ) );
            ...
            public function init_form_fields() {
                ...
                $this->form_fields = array(
                    ...
                    'webhook_url'         => array(
                        'title'             => 'Webhook URL',
                        'type'              => 'text',
                        'default'           => add_query_arg( 'wc-api', 'Etherium_Gateway', home_url( '/' ) ),
 ...
 * @version 1.0
 */
if ( !function_exists( 'add_etherium_nowpayments_to_wc' ) ) :
    function add_etherium_nowpayments_to_wc( $gateways ) {
        $gateways[] = 'Etherium_Gateway';
        return $gateways;
    }
endif;

add_filter( 'woocommerce_payment_gateways', 'add_etherium_nowpayments_to_wc' );
